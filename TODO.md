...
- [ ] テーマカラー追加オプション
- [ ] 多言語対応検討
- [ ] 仕入原価管理の検討（同一商品の仕入単価変動対応、在庫評価）
  - 関連: `lib/models/product_model.dart`, `lib/services/database_helper.dart`
  - 備考: 2026-05-22 議論済み。DB変更・画面追加が必要で深い沼のため、請求書安定化後に着手
