...
- [x] **Phase 1: SE1売上伝票バグ修正** - SE1（売上伝票）の編集保存後に内容が空になるバグを修正し、単体テストを追加
- [x] **Phase 2: 請求書インポートバグ修正** - 請求書インポート時の合計金額不一致を修正し、Widgetテストを追加
...
- [x] 02-02-PLAN.md — Widget テスト + _calculate() 単体テスト追加（Wave 2）
...
| 4. コアフロー安定化 | 0/0 | ⏭ Skipped | 2026-05-22 |
