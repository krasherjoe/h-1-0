...
class CustomField {
  ...
  bool operator ==(Object other) {
    ...
    return other is CustomField && other.id == id;
  }
  ...
  @override
  String toString() {
    return 'CustomField(id: $id, fieldName: $fieldName, fieldType: $fieldType)';
  }
}
...
class CustomFieldValue {
  ...
  bool operator ==(Object other) {
    if (identical(this, other)) return true;
    return other is CustomFieldValue && other.id == id;
  }
  ...
  @override
  String toString() {
    return 'CustomFieldValue(id: $id, customFieldId: $customFieldId, value: $value)';
  }
}
