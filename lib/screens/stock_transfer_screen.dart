...
class _StockTransferScreenState extends State<StockTransferScreen> {
  ...
  Future<void> _loadInitialData() async {
    ...
    final from = warehouses.firstWhere(
      (w) => w.id == kDefaultWarehouseId,
                            ...
                            child: GestureDetector(
                              ...
                              child: Container(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Text('移動日: ${_dateFormat.format(_transferDate)}'),
                      ...
                      : ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            return Card(
                              ...
                              child: ListTile(
                                title: Text(line.product.name, style: const TextStyle(fontWeight: FontWeight.bold)),
                                subtitle: Column(
